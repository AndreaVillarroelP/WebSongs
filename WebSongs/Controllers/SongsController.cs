...
namespace WebSongs.Controllers
{
    public class SongsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Autor,Lyrics,Link")] Song song)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Name,Autor,Lyrics,Link")] Song song)
        {
            if (id != song.Name)
            {
                return NotFound();
